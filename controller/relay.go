...
func processChannelError(c *gin.Context, channelError types.ChannelError, err *types.NewAPIError) {
	...
	logger.LogError(c, fmt.Sprintf("channel error (channel #%d, status code: %d): %s request_header=%s", channelError.ChannelId, err.StatusCode, common.LocalLogPreview(err.Error()), common.FormatArchiveRequestHeaderSnapshot(headerSnapshot)))
