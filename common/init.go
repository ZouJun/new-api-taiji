...
func InitEnv() {
	...
	RelayDefaultNonStreamTimeout = GetEnvOrDefault("RELAY_DEFAULT_NON_STREAM_TIMEOUT", 0)
	RelayDefaultStreamFirstByteTimeout = GetEnvOrDefault("RELAY_DEFAULT_STREAM_FIRST_BYTE_TIMEOUT", 0)
	AWSHTTPClientNonStreamTimeoutSeconds = GetEnvOrDefault("AWS_HTTP_CLIENT_NON_STREAM_TIMEOUT_SECONDS", 0)
	AWSHTTPClientStreamFirstByteTimeoutSeconds = GetEnvOrDefault("AWS_HTTP_CLIENT_STREAM_FIRST_BYTE_TIMEOUT_SECONDS", 0)
	AWSInvokeTimeoutSeconds = GetEnvOrDefault("AWS_INVOKE_TIMEOUT_SECONDS", 0)
